(()=>{
"use strict";
const CFG={url:"https://froegigfmpmvtecztfbf.supabase.co",fn:"/functions/v1/midad_control_room",build:"cockpit-2026-09-26"};
...
function render(){shell();const v=$("#views");if(!S.connected&&!S.token){v.innerHTML=lockView()}else if(S.view==="ai")v.innerHTML=aiView();else if(S.view==="money")v.innerHTML=moneyView();else if(S.view==="intel")v.innerHTML=intelView();else if(S.view==="tasks")v.innerHTML=tasksView();else if(S.view==="more")v.innerHTML=moreView();else v.innerHTML=cockpitView();bind()}
function bind(){
