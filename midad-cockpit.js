...
function moreView(){
 ...
 return '<div class="cr-page"><section class="hero-panel"><div class="eyebrow">MORE / TOOLS</div><h1 style="font-size:48px">الأدوات، لا الصفحات.</h1><p>أبقيت الأدوات ذات الغرض الواضح، وأخرجت الفوضى من المسار الرئيسي.</p></section><section class="more-grid section-gap"><div class="toolcard"><b>💰 المال المباشر</b><p>'+esc(moneyState)+' · Supabase Edge + pg_cron، مستقل عن n8n.</p><button class="btn green" data-run="run_money_scan">تشغيل بحث المال</button></div><div class="toolcard"><b>⛏ التعدين</b><p>ViaBTC monitor.</p><button class="btn" data-run="run_mining_monitor">تشغيل الفحص</button></div><div class="toolcard"><b>⚡ الاستقلالية</b><p>تشغيل دورة MIDAD مع بقاء بوابات الأمان.</p><button class="btn warn" data-run="run_autonomy_now">تشغيل الدورة</button></div><div class="toolcard"><b>📡 Telegram</b><p>'+esc(t.url||"لم يُفحص بعد")+'</p><button class="btn" data-cmd="telegram">فحص Telegram</button></div><div class="toolcard"><b>✺ النظام</b><p>'+esc(S.connected?"جلسة موثقة":"الجلسة مقفلة")+'</p><button class="btn" data-cmd="system">فحص الصحة</button></div><div class="toolcard"><b>◎ المحافظ</b><p>'+n((S.data?.wallets||[]).length)+' محافظ مسجلة في النواة.</p><button class="btn" data-cmd="wallets">عرض الحالة</button></div><div class="toolcard"><b>⌘ أمر سريع</b><p>نفّذ أمرًا نصيًا من الشريط العلوي.</p><button class="btn" data-cmd="focusCommand">اكتب أمرًا</button></div></section></div>'
}
